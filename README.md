...
* [Yue](https://github.com/yue/yue) - a library for creating native cross-platform desktop apps with nodejs. Uses GDI+ on Windows, Cocoa on MacOS & GTK on Linux to render the UI.
